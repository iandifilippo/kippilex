...
// ESTADO: CORREGIDO (Bug de "fondo negro" en botones)
...
                  >
                    <Link
                      // --- CORRECCIÓN: 'outline-none' añadido ---
                      className="btn group mb-4 w-full inline-block bg-gradient-to-t from-indigo-600 to-indigo-500 text-white shadow-lg rounded-full sm:mb-0 sm:w-auto outline-none"
                      href="/signup"
                    >
...
                    <Link
                      // --- CORRECCIÓN: 'outline-none' añadido ---
                      className="btn relative w-full bg-gray-800 hover:bg-gray-700 text-gray-200 border border-gray-700 shadow-lg rounded-full sm:ml-4 sm:w-auto outline-none"
                      href="/casos"
                    >
                     <span className="relative inline-flex items-center px-4 py-2">
                        Ver Casos
